...
docker run -it -v /home/islamali/work_area/datasets/KITTI/data_odometry_gray/dataset/sequences/04:/root/Dataset/04 -p 5900:5900 -p 6099:6099 --rm islamaali/orbslam2-docker:v1.0 
